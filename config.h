...
#define TAGKEYS(KEY, TAG)                                                                                              \
  {MODKEY, KEY, view, {.ui = 1 << TAG}}, {MODKEY | ControlMask, KEY, toggleview, {.ui = 1 << TAG}},                    \
      ...
      {MODKEY | ControlMask | ShiftMask, KEY, toggletag, {.ui = 1 << TAG}}, {MODKEY, KEY, focusnthmon, {.ui = TAG}},   \
      {MODKEY | ShiftMask, KEY, tagnthmon, {.ui = TAG}},
...
static Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3) TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5)
        TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7) TAGKEYS(XK_9, 8){MODKEY | ShiftMask, XK_z, quit, {0}},
};
